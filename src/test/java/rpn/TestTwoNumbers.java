...
public class TestTwoNumbers {
    ...
    should_return_3_when_1_2_plus() throws Exception {
        String result = Polish.evaluate("1 2 +");
    ...
    should_return_4_when_2_2_plus() throws Exception {
        String result = Polish.evaluate("2 2 +");

        assertThat(result).isEqualTo("4");
    }

    @Test public void
    should_return_minus12_when_minus6_minus6_plus() throws Exception {
        String result = Polish.evaluate("-6 -6 +");
    ...
    should_return_2_when_3_1_minus() throws Exception {
        String result = Polish.evaluate("3 1 -");
    ...
    should_return_minus5_when_0_5_minus() throws Exception {
        String result = Polish.evaluate("0 5 -");
    ...
    should_return_30_when_5_6_times() throws Exception {
        String result = Polish.evaluate("5 6 *");
    ...
    should_return_0_when_0_10_times() throws Exception {
        String result = Polish.evaluate("0 10 *");
    ...
    should_return_5_when_100_20_dividedby() throws Exception {
        String result = Polish.evaluate("100 20 /");
    ...
    should_throw_exception_when_5_0_dividedby() {
        assertThatCode(() -> {
            String result = Polish.evaluate("5 0 /");
    ...
    should_not_throw_any_exception_when_5_1_dividedby() {
        assertThatCode(() -> {
            String result = Polish.evaluate("5 1 /");
